/* 
  * Matrix Mod Menu v2 created by MathPRIME
  * Website: https://github.com/francamatheus165-prog/matrix-client-2.0
  * Youtube: https://github.com/francamatheus165-prog/matrix-client-2.0
  * Discord: https://github.com/francamatheus165-prog/matrix-client-2.0
  * GitHub: https://github.com/francamatheus165-prog/matrix-client-2.0
  * By a MineFunner, for a MineFunner.
*/

/*
  * Copyright © 2026 Matrix Client / MathPRIME
  * ALL RIGHTS RESERVED

  * This source code is proprietary. Copying, reusing, modifying, redistributing with or without AI without explicit
  * Matrix Client / MathPRIME source.
...
<svg xmlns="http://www.w3.org/2000/svg"
        ...
        byId("tex-browse").addEventListener("click", async () => {
          ...
          try {
            const res = await fetch(
              `https://raw.githubusercontent.com/francamatheus165-prog/matrix-client-2.0/main/client/texturepacks.json?t=${Date.now()}`,
            );
  ...
  registerMod({
    ...
    async _loadArmorImages() {
      const url = "https://raw.githubusercontent.com/francamatheus165-prog/matrix-client-2.0/main/client/armor/armor.json";
    ...
    options: {
      ...
      bind() {
        ...
        byId("customui-browse").addEventListener("click", async () => {
          ...
          try {
            const res = await fetch(
              `https://raw.githubusercontent.com/francamatheus165-prog/matrix-client-2.0/main/client/ui.json?t=${Date.now()}`,
            );
...
<div id="__cs_options_panel">
  ...
  `;
    ...
    discordTip.href = "https://github.com/francamatheus165-prog/matrix-client-2.0";
